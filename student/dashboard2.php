			...
			<div class="page-header">
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 text-right">
						<div class="dropdown">
							<a class="btn btn-primary dropdown-toggle" href="index2.html#" role="button" data-toggle="dropdown">
								January 2018
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<a class="dropdown-item" href="index2.html#">Export List</a>
								<a class="dropdown-item" href="index2.html#">Policies</a>
								<a class="dropdown-item" href="index2.html#">View Assets</a>
							</div>
						</div>
					</div>
				</div>
