	...
	include 'geter.php';
	$function = "admin with name  ".$full_name." is about to add new department to the system through excel upload";
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Upload Department Excel</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">Upload Department Excel</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="POST"  action="Uploader.dept" enctype="multipart/form-data"  > 
						<div class="row">
							<div class="col-md-6 col-sm-12">
