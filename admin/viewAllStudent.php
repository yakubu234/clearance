	...
	include 'geter.php';
	$function = "admin with name  ".$full_name." is viewing all student data ";
	LoadUser($userid, $full_name, $admin_email, $function);
	$allData =generateAllStudent();
	?>
						...
						<table class="table hover multiple-select-row data-table-export nowrap">
							...
							<tbody>
								...
								foreach ($allData as $key => $value) {
									...
									<td> <a href="../classes/action.php?data='.time().'&strings='.$value["id"].'&params=vis&dept='.$value["department"].'" > <i class="far fa-eye" ></i></a></td>
									</tr>
								';
								}
							}
