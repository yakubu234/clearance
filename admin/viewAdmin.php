	...
	include 'geter.php';
	$function = "admin with name  ".$full_name." is viewing lists of admins ";
	LoadUser($userid, $full_name, $admin_email, $function);

	$allData =getAdminList();
	?>
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">View list of admin</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-6 col-sm-12 ">
						...
						<table class="table hover multiple-select-row data-table-export " width="100%">
							...
							<tbody>
								...
								foreach ($allData as $key => $value) {
									...
									<td> <a href="../classes/action.php?data='.time().'&strings='.$value["id"].'&val=AdEd&name='.$value["username"].'" > <i class="far fa-trash-alt text-danger" ></i></a></td>
									</tr>
								';
								}
							}
