	...
	include 'geter.php';
	$function = "admin with name  ".$full_name." is viewing lists of departments available in the system ";
	LoadUser($userid, $full_name, $admin_email, $function);

	$allData =getDepartment();
	?>
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>View list of Departments</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">View list of Departments</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-6 col-sm-12 ">
						...
						<table class="table hover multiple-select-row data-table-export " width="100%">
							...
							<tbody>
								...
								foreach ($allData as $key => $value) {
									...
									<td>'.$value["time_reg"].'</td>
									<td> <a href="../classes/action.php?data='.time().'&strings='.$value["id"].'&val=DAdEd&name='.$value["name"].'" > <i class="far fa-trash-alt text-danger" ></i></a></td>
									</tr>
								';
								}
							}
