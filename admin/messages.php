							...
							<div class="chat-detail">
								<div class="chat-profile-header clearfix">
									...
									<div class="right text-right">
										<div class="dropdown">
											<a class="btn btn-outline-primary dropdown-toggle" href="chat.html#" role="button" data-toggle="dropdown">
												Setting
											</a>
											<!-- <div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="chat.html#">Export Chat</a>
												<a class="dropdown-item" href="chat.html#">Search</a>
												<a class="dropdown-item text-light-orange" href="chat.html#">Delete Chat</a>
											</div> -->
										</div>
									</div>
								</div>
								<div class="chat-box">
									...
									<div class="chat-footer">
										<div class="file-upload"><a href="chat.html#"><i class="fa fa-paperclip"></i></a></div>
