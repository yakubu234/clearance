	...
	include 'geter.php';
	$dept = $_GET['data'];
	$function = "admin with name  ".$full_name." is viewing student from ".$dept ." department ";
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>View <?php echo $dept; ?> department student lists</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">View <?php echo $dept; ?> department student lists</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-6 col-sm-12 ">
				...
				<div class="card-box mb-30"><br>
					<div class="pb-20">
						<table class="table hover multiple-select-row data-table-export " width="100%">
							...
							<tbody>
								<?php 
								if(!empty($_SESSION['dataSel'])){
								foreach ($_SESSION['dataSel'] as $key => $value) {
									echo '
									<tr>
									<td >'.($key +1).'</td>
									...
									<td> <a href="'.$urlServer.'classes/action?params=individualStudent&data='.time().'&strings='.$value["id"].'" > <i class="far fa-eye" ></i></a></td>
									</tr>
								';
								}
							}
