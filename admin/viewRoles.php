	...
	include 'geter.php';
	 $function = "user with name ".$username." just  viewed roles ";
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>View roles in database</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">View roles in database</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-6 col-sm-12 ">
						...
						<table class="table hover multiple-select-row data-table-export " width="100%">
							...
							<tbody>
								...
								foreach ($allData as $key => $value) {
									...
									<td style="width:40%;">'.$value["reg_time"].'</td>
									<td> <a href="../classes/action.php?par='.$value["name"].'&data='.time().'&strings='.$value["id"].'&val=rolesd&name='.$value["creator_name"].'" > <i class="far fa-trash-alt text-danger" ></i></a></td>
									</tr>
								';
								}}
								 ?>
